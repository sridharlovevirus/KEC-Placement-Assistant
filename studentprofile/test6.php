...
$s1="delete from bsc where rollno='$rollno'";
$s2="delete from be where rollno='$rollno'";
$s3="delete from mca where rollno='$rollno'";
$s4="delete from msc where rollno='$rollno'";
mysql_query($s1,$con);
mysql_query($s2,$con);
mysql_query($s3,$con);
mysql_query($s4,$con);
...
$my="select rollno from mba where rollno='$rollno'";
$r1=mysql_query($my,$con);
  $rowcount=mysql_num_rows($r1);
  if($rowcount==0)
  {
	  $sql="insert into mba values('$rollno','$eexam','$madmin','$co','$fgen','$ugcollege','$ugper','$ugspec','$sem1','$sem2','$sem3','$sem4','$currentpercentage','$historyarrear','$standingarrear','$clearedarrear','$coursestart','$ce')";
	  mysql_query($sql,$con);
  ...
  {
	  $sql="update mba set rollno='$rollno',eexam='$eexam',madmin='$madmin',co='$co',fgen='$fgen',ugcollege='$ugcollege',ugper='$ugper',ugspec='$ugspec',sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',cp='$currentpercentage',ha='$historyarrear',sa='$standingarrear',ca='$clearedarrear',cs='$coursestart',ce='$ce' where rollno='$rollno'";
	    mysql_query($sql,$con);
	echo mysql_error($con);
...
<body class="bg-primary w-100 h-100 border border-dark text-danger">
  ...
  <div class="container">
    ...
    <label for="eexam" class="control-label"><b>Select The Enterance Exam?</b></label><b>
    <div class="input-group">
   <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
	  
      <select class="form-control" name="eexam" id="eexam" required="">
	  <option></option>
    ...
    <label for="madmin" class="control-label"><b>Select The Mode of Admission?</b></label><b>
    <div class="input-group">
   <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
	  
      <select class="form-control" name="madmin" id="madmin" required="">
	  <option></option>
  ...
  <div class="form-group has-feedback">
    <label for="ugcollege" class="control-label"><b>Enter your Ug College Name:</b></label><b>
    <div class="input-group">
   <span class="input-group-addon"><i class="glyphicon glyphicon-stats"></i></span>
	  
      <input type="text" pattern="[a-zA-Z]+" class="form-control" name="ugcollege" id="ugcollege" placeholder="College Name" required="">
    </div>
    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
    <div class="help-block with-errors"></div>
  </b></div><b>
   ...
   <div class="form-group has-feedback">
    <label for="ugper" class="control-label"><b>Enter your Ug Percentage:</b></label><b>
    <div class="input-group">
   <span class="input-group-addon"><i class="glyphicon glyphicon-stats"></i></span>
	  
      <input type="number" pattern="[0-9]{3}" min="1" max="100" class="form-control" name="ugper" id="ugper" placeholder="Percentage" required="">
    </div>
    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
    <div class="help-block with-errors"></div>
  </b></div><b>
   ...
   <div class="form-group has-feedback">
    <label for="ugspec" class="control-label"><b>Enter your Ug Specification:</b></label><b>
    <div class="input-group">
   <span class="input-group-addon"><i class="glyphicon glyphicon-stats"></i></span>
	  
      <input type="text" pattern="[a-zA-Z]+" class="form-control" name="ugspec" id="ugspec" placeholder="Specification" required="">
    </div>
    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
    <div class="help-block with-errors"></div>
  </b></div>
