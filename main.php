...
<div class="container">
  ...
  <div class="row">
	...
	<hr>
	<center>
      <a href="student.php"><div class="do-item do-item-circle do-circle">
        ...
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            ...
            <div class="do-info-back do-circle">
              ...
              <div><u> <h3>Student Details</h3></u></div>
            </div>
          </div>
        </div>
      </div></a>
    ...
    <div class="col-sm-6">
	<hr><center>
      <a href="add.php"><div class="do-item do-item-circle do-circle">
        <img src="image/staff1.png" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <div class="do-info-back do-circle">
              
              <div><u><h3>Staff Management</h3> </u>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            ...
            <div class="do-info-back do-circle">
              ...
              <div>
                <a href="company.php"><u> <h3>Company Details</h3></u></a><div>
            </div>
          </div>
        </div>
		</center>
        ...
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            ...
            <div class="do-info-back do-circle">
                ...
                <a href="forum.php">  <h3><u>Feedback Management</u></h3></a><div>
            </div>
          </div>
        </div>
		</center>
