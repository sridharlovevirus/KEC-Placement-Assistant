  ...
  <div class="row">
	...
	<center>
      <div class="do-item do-item-circle do-circle">
        <img src="image/up.gif" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <a href="student.php"><div class="do-info-back do-circle">
	...
	<hr><center>
      <div class="do-item do-item-circle do-circle">
        <img src="image/search.gif" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <a href="search.php"><div class="do-info-back do-circle">
	...
	<hr><center>
      <div class="do-item do-item-circle do-circle">
        <img src="image/mail.gif" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
           <a href="mailbox.php"> <div class="do-info-back do-circle">
               <h3>Mail</h3>
              <div>
               </a><div>
            </div>
