...
$s="select finish from studentpersonal where rollno='$user'";
	$qo=mysql_query($s);
		$row5=mysql_fetch_array($qo);
		$rt="select d from sem where dept='$pt'";
		$rt1=mysql_query($rt);
		$row6=mysql_fetch_array($rt1);
		$tr="select rollno from markupdate where rollno='$user'";
		$www=mysql_query($tr);
		$ccc=mysql_num_rows($www);
...
echo "<div class='box-body'>
	 <div class='alert alert-danger alert-dismissible'>
		 ...
		 <a href='profile.php'><button type='button' class='btn btn-block btn-warning btn-sm'>Click to Update</button></a>
              </div>
...
if(($row6['d']!="")&&($ccc==0))
{
	echo "<div class='box-body'>
	 <div class='alert alert-danger alert-dismissible'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4><i class='icon fa fa-close'></i> Alert!</h4>
         Your Semester ".$row['sem']." mark is not updated !!!
		 <a href='semup.php'><button type='button' class='btn btn-block btn-warning btn-sm'>Click to Update</button></a>
              </div>
...
if($roll==$pass)
{
	echo "<div class='box-body'>
	 <div class='alert alert-danger alert-dismissible'>
		 ...
		 <a href='chpass.php'><button type='button' class='btn btn-block btn-warning btn-sm'>Click to Update</button></a>
              </div>
  ...
  <div class="row">
	...
	<center>
      <div class="do-item do-item-circle do-circle">
        <img src="image/stuicon.png" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <div class="do-info-back do-circle">
             
              <div><a href="studentprofile.php"><u> <h3>Update ur profile</h3></u></a></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            ...
            <div class="do-info-back do-circle">
              ...
              <div><a href="mailbox.php"><u><h3>Mail</h3> </u></a>
                </div>
            </div>
          </div>
        </div>
	...
	<hr><center>
      <div class="do-item do-item-circle do-circle">
        <img src="image/com.png" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <div class="do-info-back do-circle">
              ...
              <div>
                <a href="companydetails.php"><u> <h3>View Company information</h3></u></a><div>
            </div>
          </div>
        </div>
		</center>
	...
	<hr><center>
      <div class="do-item do-item-circle do-circle">
        <img src="image/feed.png" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <div class="do-info-back do-circle">
                ...
                <a href="forum.php">  <h3><u>Feedback</u></h3></a><div>
            </div>
          </div>
        </div>
		</center>
