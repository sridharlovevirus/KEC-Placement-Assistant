  ...
  <div class="row">
	...
	<center>
      <div class="do-item do-item-circle do-circle">
        <img src="image/aevent.png" class="do-item do-circle" width="50pt" height="50pt">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <div class="do-info-back do-circle">
             
              <div><a href="addevent.php"><u> <h3>Add Event details</h3></u></a></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            ...
            <div class="do-info-back do-circle">
              ...
              <div><a href="updateevent.php"><u><h3>Update Event details</h3> </u></a>
                </div>
            </div>
          </div>
        </div>
