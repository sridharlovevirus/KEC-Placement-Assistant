...
<center><font color="white"><h2>Student Details</h2></font></center>
<center><a href="student.xlsx"><img src="excel.png" width="20pt" height="20pt"><b>Download Template</b></a></center><br><br>
<?php
session_start();
error_reporting(0);
if($_SESSION['exit']==1)
