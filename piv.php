 ...
 <?php
	...
	echo "<hr><center>
      <div class='do-item do-item-circle do-circle'>";
        echo "<img src='image/upload.png' class='do-item do-circle'>";
        echo "<div class='do-info-wrap do-circle'>";
          echo "<div class='do-info'>";
            ...
            echo "<div class='do-info-back do-circle'>";
              ...
              echo "<div><a href='upiv.php'><u> <h3>Update Placed Student info</h3></u></a>
                </div>
            </div>
          </div>
        </div>
        ...
        echo "<div class='do-info-wrap do-circle'>";
          echo "<div class='do-info'>";
            ...
            echo "<div class='do-info-back do-circle'>";
              ...
              echo "<div><a href='viewpiv.php'><u> <h3>View Placed Student info</h3></u></a>
                </div>
            </div>
          </div>
        </div>
