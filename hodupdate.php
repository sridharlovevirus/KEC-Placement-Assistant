...
<body>
<center>
<form action="hodupdate1.php" method="post"  enctype="multipart/form-data">
<center><font color="white"><h2>Update Staff Details</h2></font></center>
<center><a href="hod.xlsx"><img src="excel.png" width="20pt" height="20pt">Download Template</a></center><br><br>
<?php
session_start();
error_reporting(0);
if($_SESSION['exit']==1)
