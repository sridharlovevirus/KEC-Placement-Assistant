...
$query="select * from login where id='$user'";
						 ...
						 if(isset($_POST['submit']))
						 {
							 ...
							 $phone=$_POST['phone'];
							 $add=$_POST['add'];
							 $s="insert into company values('','$cname','$add','$cmail','$phone')";
							 mysql_query($s);
...
<div class="container">
  ...
  <form action="" method="post" id="contact_form">
    <div class="name">
      ...
      <input type="text" pattern="[a-zA-Z ]{3,20}" placeholder="Company Name:" name="name" id="name_input" required>
    </div>
    <div class="email">
      <label for="email"></label>
      <input type="email" placeholder="Company E-mail " name="email" id="email_input" required>
    </div>
    <div class="telephone">
      <label for="name"></label>
      <input type="text"  pattern="^[8-9]{1}[0-9]{9}" placeholder="Company Mobile number " name="phone" id="telephone_input" required>
    </div>
  
    <div class="message">
      <label for="message"></label>
      <textarea name="add" pattern="[a-zA-Z]{10,200}" placeholder="Company Address" id="message_input" cols="30" rows="5" required></textarea>
    </div>
    <div class="submit">
      <input type="submit" value="Add Company" name="submit" id="form_button" />
    </div>
  </form><!-- // End form -->
</div><!-- // End #container -->
