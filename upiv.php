...
<form action="pivupdate.php" method="post"  enctype="multipart/form-data">
<b><center><img src="excel.png" width="20pt" height="20pt"><a href="pl.xlsx">Download Excel template</a></center>
