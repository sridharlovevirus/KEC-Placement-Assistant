...
if($_SESSION['role']=='hod')
{
        ...
        echo "<div class='do-info-wrap do-circle'>";
          echo "<div class='do-info'>";
            ...
            echo "<div class='do-info-back do-circle'>";
              ...
              echo "<div><a href='staffupload.php'> <u><h3>Upload staff details</h3></U></a></div>";
            echo "</div></div> </div> </div> </center></div>";
	 echo "<div class='col-sm-6'>";
	echo "<hr><center>";
      echo "<div class='do-item do-item-circle do-circle'>";
        echo "<img src='image/update.gif' class='do-item do-circle' height='20px' width='20px'>";
        echo "<div class='do-info-wrap do-circle'>";
          echo "<div class='do-info'>";
            echo "<div class='do-info-front do-circle'></div>";
            echo "<div class='do-info-back do-circle'>";
             
              echo "<div><a href='staffupdate1.php'><u> <h3>Update Staff Details</h3></u></a></div></div></div></div></center></div>";
			  }
			  else
	...
	echo "<hr><center>";
      echo "<div class='do-item do-item-circle do-circle'>";
        echo "<img src='image/search1.gif' class='do-item do-circle'>";
        ...
        echo "<div class='do-info-wrap do-circle'>";
          echo "<div class='do-info'>";
            ...
            echo "<div class='do-info-back do-circle'>";
              ...
              echo "<div><a href='staffsearch.php'> <u><h3>Search staff details</h3></U></a></div>";
            echo "</div></div> </div> </div> </center></div>";
	 echo "<div class='col-sm-6'>";
	echo "<hr><center>";
      echo "<div class='do-item do-item-circle do-circle'>";
        echo "<img src='image/mail.gif' class='do-item do-circle' height='20px' width='20px'>";
        echo "<div class='do-info-wrap do-circle'>";
          echo "<div class='do-info'>";
            echo "<div class='do-info-front do-circle'></div>";
            echo "<div class='do-info-back do-circle'>";
             
              echo "<div><a href='mailbox.php'><u> <h3>mail</h3></u></a></div></div></div></div></center></div>";
				  }
			  ?>
