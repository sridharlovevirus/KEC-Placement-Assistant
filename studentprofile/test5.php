...
$my="select rollno from mca where rollno='$rollno'";
$r1=mysql_query($my,$con);
  $rowcount=mysql_num_rows($r1);
  if($rowcount==0)
  {
	  $sql="insert into mca values('$rollno','$eexam','$madmin','$co','$fgen','$ugcollege','$ugper','$ugspec','$sem1','$sem2','$sem3','$sem4','$sem5','$sem6','$currentpercentage','$historyarrear','$standingarrear','$clearedarrear','$coursestart','$ce')";
	  mysql_query($sql,$con);
  ...
  {
	  $sql="update mca set rollno='$rollno',eexam='$eexam',madmin='$madmin',coption='$co',fgen='$fgen',ugcollege='$ugcollege',ugper='$ugper',ugspec='$ugspec',sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',sem5='$sem5',sem6='$sem6',cp='$currentpercentage',ha='$historyarrear',sa='$standingarrear',ca='$clearedarrear',cs='$coursestart',ce='$ce' where rollno='$rollno'";
	    mysql_query($sql,$con);
	echo mysql_error($con);
