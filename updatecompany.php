...
if(isset($_POST['delete']))
{
	...
	$rt="delete from company where cno='$id'";
	mysql_query($rt);
	echo "<script>alert('Company detail deleted successfully')</script>";
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered">
               ...
               <?php
while($row11=mysql_fetch_array($e))
{	
			   echo "<tr>";
			   echo "<td>".$row11['cno']."</td>";
                  echo "<td>".$row11['cname']."</td>";
                  echo "<td>".$row11['address']."</td>";
				  echo "<td>".$row11['mailid']."</td>";
				  			  echo "<td>".$row11['contact']."</td>";
                  echo "<td><button name='edit' value=$row11[cno] class='btn btn-block btn-info'>Edit</button><button name='delete' value=$row11[cno] class='btn btn-block btn-danger btn-flat'>Delete</button></td>";
