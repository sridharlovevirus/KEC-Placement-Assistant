...
$coursestart=$_POST['coursestart'];
	$my="select rollno from bsc where rollno='$rollno'";
$r1=mysql_query($my,$con);
  $rowcount=mysql_num_rows($r1);
  if($rowcount==0)
  {
	  $sql="insert into bsc values('$rollno','$madmin','$co','$fgen','$sem1','$sem2','$sem3','$sem4','$sem5','$sem6','$currentpercentage','$historyarrear','$standingarrear','$clearedarrear','$coursestart','$ce')";
	  mysql_query($sql,$con);
  ...
  {
	  $sql="update bsc set rollno='$rollno',madmin='$madmin',coption='$co',fgen='$fgen',sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',sem5='$sem5',sem6='$sem6',cp='$currentpercentage',ha='$historyarrear',sa='$standingarrear',ca='$clearedarrear',cs='$coursestart',ce='$ce' where rollno='$rollno'";
	    mysql_query($sql,$con);
	echo mysql_error($con);
