...
<div class="container">
  ...
  <div class="row">
	...
	<hr>
	<center>
      <a href="addhod.php"><div class="do-item do-item-circle do-circle">
    ...
    <div class="col-sm-6">
	<hr><center>
      <a href="hodupdate.php"><div class="do-item do-item-circle do-circle">
        <img src="image/update1.gif" class="do-item do-circle">
        <div class="do-info-wrap do-circle">
          <div class="do-info">
            <div class="do-info-front do-circle"></div>
            <div class="do-info-back do-circle">
              
              <div><u><h3>Update hod Details </h3> </u>
                </div>
            </div>
          </div>
        </div>
     ...
     <div class="col-sm-6">
	<hr><center>
      <a href="staffdetails.php"><div class="do-item do-item-circle do-circle">
