        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <?php echo "<img src='$_SESSION[dp]' class='user-image' alt='User Image'>";
			  ?>
            ...
            <ul class="dropdown-menu">
			  ...
			  $user=$_SESSION['user'];
                ...
                echo"<img src='$_SESSION[dp]' class='img-circle' alt='User Image'>";
?>
                <p>
...
<?php           echo "<img src='$_SESSION[dp]' class='img-circle' alt='User Image'>";
?>
        </div>
 ...
 <aside class="profile-card">
  ...
  <div>
    ...
    <a href="profileupload.php">
	    ...
	    <?php echo "<img  class='hoverZoomLink' src='$_SESSION[dp]'>";?>
...
<a href="viewpro.php">View ur profile &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
echo "<span class='glyphicon glyphicon-phone'></span>&nbsp;&nbsp;&nbsp;&nbsp;";			
 ...
 <section>
 <a href="./studentprofile/new.php">
<button id="js-trigger-overlay" type="button" form action="form.php">Update Your Profile</button>
</a>
</form>
  </section>
  </div>
