...
{
 echo "<a href='./excel/excel.php'>"; 
echo "<center><img src='./image/download.png' width='50pt' height='50pt'></center>";
echo "<center><b>Download Older Details</b></center></a><br><br>";
}
else
if($_SESSION['role']=='hod')
{
	echo "<a href='./excel/excel2.php'>"; 
echo "<center><img src='./image/download.png' width='50pt' height='50pt'></center>";
echo "<center><b>Download Older Details</b></center></a><br><br>";
}
	
 echo "<a href='staffupdateexcel.php'>"; 
echo "<center><img src='./image/uploadexcel.png' width='40pt' height='40pt'></center>";
echo "<center><b>Update Staff Details</b></center></a>";
